...
published: true
---
h2. 1. Qu'est ce qu'une usine logicielle ?
...
h2. 2. Installation et mise en place
...
h3. 2.1. Installation et configuration du contrôleur de code source : Git
...
h3. 2.2. Installation et configuration de Jenkins

h4. 2.2.1. Installation de Jenkins
...
h4. 2.2.2. Configuration de la construction des sources du projet
...
h5. 2.2.2.1. Configuration des outils .Net
...
h5. 2.2.2.2. Creation du job d'intégration
...
h5. 2.2.2.3. Configuration du dépot Git
...
h5. 2.2.2.4. Déclenchement du build
...
h5. 2.2.2.5. Compilation des sources
...
h5. Configuration d'une tache de tests unitaires
...
h5. 2.2.2.6. Mesure de la couverture de code
...
h5. 2.2.2.7. Archivage de fichiers de build
...
h4. 2.2.3. Mises en place de métriques de notre code
...
h5. 2.2.3.1. La Complexité ciclomatique : CCM
...
h5. 2.2.3.2. Métriques de qualité du code source : "Violations":https://wiki.jenkins-ci.org/display/JENKINS/Violations 
...
h5. 2.2.3.3. Détection de tàches à faire : Task Scanner Plugin
...
h5. 2.2.3.4. Détection des similarités de code : Simian / Dry Plugin
...
h5. 2.2.3.5. Suivi des Warnings de compilation : "Warnings Plugin":https://wiki.jenkins-ci.org/display/JENKINS/Warnings+Plugin 
...
h4. 2.2.4. Installation facile et rapide : Bonus exceptionnel!!!!! ;)
