...
published: false
---
hh2. Qu'est ce qu'une usine logicielle ?
...
Lancez l’installation (Suivant, suivanh3. et répondez au 2 questions (format de fin de ligne des fichiers et intégration de git dans le système) suivants vos besoins. Les choix par défaut conviennent la plupart du temps.
...
Dans “MsBuild Version”, vous devez retrouver la ligne correspondant à la configuration que vous avez effectuée à l'étape "§h4. Configuration des outils .Net". Sélectionnez là.
...
Installation FxCop depuis “C:\Program Files (x86)\Microsoft SDKs\Windows\v7.0A\FXCop\FxCopSetup.exe” (FxCop est fourni dans le sdk h2. ou 7.1)
...
Ce plugin permet de détecter des chaines de caractères types (FIXME, TODOh3. dans les commentaires et de suivre leur évolution.
