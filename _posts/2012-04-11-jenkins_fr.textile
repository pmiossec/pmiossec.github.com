...
!../images/Jenkins_09_couverture.png(Résultats de la couverture de code)!
...
!../images/metrique_01_CCM.png(Suivi de la complexité du code pour les différents builds)!
...
!../images/Jenkins_10_metriques_violation.png(Graphe de suivi des métriques d'analyse de code)!
...
!../images/metrique_02_OpenTasks.png(Suivi des tâches laissées ouverte dans le code source)!
...
!../images/metrique_06_Similarités.png(Affichage des similarités, ou code dupliqué, dans le dernier build)!
...
!../images/metrique_03_Warnings.png(Suivi des Warnings de compilation)!
