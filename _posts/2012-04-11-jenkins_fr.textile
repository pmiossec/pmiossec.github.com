...
p=. !../images/Jenkins_01_ecran_principal.png(Ecran principal de Jenkins avec 2 projets configurés)!
...
p=. !../images/Jenkins_07_resultat_compilation.png(Ecran de résultat d'un build avec l'ensemble des métriques disponibles)!
...
p=. !../images/Jenkins_08_resultat_tests.png(Résultats des tests untaires des différents builds)!
...
p=. !../images/Jenkins_09_couverture.png(Résultats de la couverture de code)!
...
p=. !../images/metrique_01_CCM.png(Suivi de la complexité du code pour les différents builds)!
...
p=. !../images/Jenkins_10_metriques_violation.png(Graphe de suivi des métriques d'analyse de code)!
...
p=. !../images/metrique_02_OpenTasks.png(Suivi des tâches laissées ouverte dans le code source)!
...
p=. !../images/metrique_06_Similarités.png(Affichage des similarités, ou code dupliqué, dans le dernier build)!
...
p=. !../images/metrique_03_Warnings.png(Suivi des Warnings de compilation)!
