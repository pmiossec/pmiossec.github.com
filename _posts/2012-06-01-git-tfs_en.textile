...
@git tfs clone http://myTfsServer:8080/tfs/TfsRepository $/MyProject/TroncName .@

* En ne récupérerant que le dernier commit du dépot
@git tfs quick-clone http://myTfsServer:8080/tfs/TfsRepository $/MyProject/TroncName .@
