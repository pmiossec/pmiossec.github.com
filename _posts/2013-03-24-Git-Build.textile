...
2. Copy the 2 files !https://raw.github.com/pmiossec/git-build/master/(git-build_success.png)! and !https://raw.github.com/pmiossec/git-build/master/git-build_fail.png(git-build_fail.png)! in the same directory keeping the names "git-build_success.png" and "git-build_fail.png".
...
bc. git config private-build.command "msbuild mybuild.build /t:UnitTests /p:Configuration:Debug"
