...
|_. Name|_. Cmd.|_. Arguments|
|Tfs(Branche)> Fetch|sh|bc. -c "git tfs fetch -i $(echo {sRemoteBranch} &#124; sed 's/tfs\///')" |
|Tfs(Branche)> Fetch and rebase|sh|bc. -c "git tfsrebasebranch $(echo {sRemoteBranch} &#124; sed 's/tfs\///')" |
