...
Utilisation d'un .gitignore global (si vous ne voulez pas archiver le fichier .gitignore dans TFS) => Copie du ".gitignore_global":../../../../../files/article_git/.gitignore_global ( ou celui de "GitHub":https://github.com/github/gitignore )
Copie dans votre répertoire utilisateur et Edition du ".gitconfig":../../../../../files/article_git/.gitconfig (mettre vos informations personnelles!)
