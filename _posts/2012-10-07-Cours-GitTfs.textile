...
Parmis les contrôleur de code source, "TFS est celui le plus détesté par les développeurs :( et Git celui le plus apprécié":http://www.infoq.com/news/2010/03/Review-Version-Control-Systems .
Nous allons essayer de contourner les problèmes du 1er grâce au second...
...
_Avant-propos : Pour consulter l'aide d'une commande :_
...
Les configuration nécessaires pour faire fonctionner Git sous Windows!: 
...
!={width: 220px; height: 117px;}http://git-scm.com/figures/18333fig0317-tn.png!
...
!={width: 195px; height: 93px;}http://git-scm.com/figures/18333fig0329-tn.png!
...
h3. Inconvénient:
* Ticket d'entrée légèrement plus important (il faut comprendre/visualiser les manipulation du DAG)
