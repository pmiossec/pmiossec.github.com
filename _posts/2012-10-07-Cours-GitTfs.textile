...
Nous allons essayer de contourner les problèmes du 1er grâce au 2ond...
...
* Verifier que le répertoire 'bin' de Git est dans le path ainsi que les outils p4merge et notepad++.
...
Commande de clone (dans le répertoire courant) du dépot TFS avec historique (conseillé!):
