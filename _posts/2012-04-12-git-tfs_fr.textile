...
* En récupérant l'historique commplet du dépot
...
Note : Lors de commit, on peut ajouter des références aux éléments de travail pour les associer ou les clore (lors de l'utilisation de rcheckin). Voici la syntaxe :
