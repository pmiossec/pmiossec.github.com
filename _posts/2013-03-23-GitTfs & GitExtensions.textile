...
bc. git s rcheckin --quick --autorebase

ou, en version courte :

bc. git s rcheckin --quick -a
...
|Tfs.Commit|@git@|@s rcheckin --quick --autorebase@|
...
bc. git tfs branch $/MonProjet/BrancheACréer <nomOptionnelLocalDeMaBranche> --comment="Commentaire de création de branche"
...
Pour commiter sur la branche sur TFS:
