...
h3. 5.7.Gestion d'une branche de TFS:
...
h3. 5.8.Scripts GitExtension (suite):
...
h3. 5.9.Nouvelle commandes de gestion des branches
...
Note : vous pouvez toujours consulter l'aide avec la commande : `git tfs branch --help`.

h3. 5.10.Travailler avec les shelvesets
